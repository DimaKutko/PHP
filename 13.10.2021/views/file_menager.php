...
<div class="container">
    <form action="/file_menager/upload" enctype="multipart/form-data" method="POST">
        <div class="mb-3">
    ...
    <table class="table">
        ...
        <tbody>
            <?php foreach ($images as $value) { ?>
                <tr>
                    <td>
                        <form action="/file_menager/rename" method="POST">
                            <div class="mb-3">
                    ...
                    <td>
                        <form action="/file_menager/delete" method="post">
